  ...
  return (
    <div className="min-h-screen bg-stone-100">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-6 lg:grid-cols-[220px_1fr]">
        ...
        <aside className="h-max rounded-xl border bg-white p-3">
          <nav className="space-y-1 text-sm">
            <Item to="/admin" icon={<LayoutDashboard size={16} />}>
              Overview
            </Item>
            <Item to="/admin/orders" icon={<Package size={16} />}>
              Orders
            </Item>
            <Item to="/admin/categories" icon={<FolderKanban size={16} />}>
              Categories
            </Item>
            <Item to="/admin/products" icon={<Package size={16} />}>
              Products
            </Item>
            <Item to="/admin/products/new" icon={<ImagePlus size={16} />}>
              New Product
            </Item>
          </nav>
        </aside>
...
function Item({ to, icon, children }) {
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        `flex items-center gap-2 rounded-lg px-3 py-2 hover:bg-stone-100 ${
